// This program uses a two-dimensional array. The data stored in the array is read in from a file.
#include <iostream>
#include <fstream>
#include <iomanip>
using namespace std;
...
int main() {
    ...
    if (!inputFile)
        ...
        // Nested loops are used to fill the array with quarterly sales figures
        // for each division and to display the data
