...
int main() {
    ...
    // Copy it into destination array and print
...
// This function accepts two characters arrays as arguments.       *
// The function assumes the two arrays contain C-strings.          *
// The contents of the second array are copied to the first array. *
//******************************************************************
void stringCopy(char destStr[], const char sourceStr[])
{
    int index = 0;
    // Copy one character at a time till we come to the null terminator
